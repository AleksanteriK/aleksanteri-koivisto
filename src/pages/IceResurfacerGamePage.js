                ...
                <Container style={{backgroundColor: '#1f2127'}}>
                        ...
                        <Col xs={10} md={8} lg={6} className="d-flex flex-column align-items-center">
                            <div style={{ padding: '1rem', backgroundColor: '#282c34', borderRadius: '10px', marginBottom: '10px', fontSize: '1.20rem'}}>
                                <div style={{textAlign: 'center' }}>
                                    <strong>About</strong>
                                    <p></p>
                                    <small>I started developing this during the summer of 2025 and the development has been going on now for over a year. </small>
                    ...
                    <Row className='justify-content-center' style={{ marginTop: '1rem' }}>
                        <Col xs={10} md={8} lg={6} className="d-flex flex-column align-items-center">
                            <div style={{ padding: '1rem', backgroundColor: '#282c34', borderRadius: '10px', marginBottom: '10px', fontSize: '1.20rem'}}>
                                <div style={{textAlign: 'center' }}>
                                    <Link to = "https://crowback-studios.itch.io/ice-resurfacing-simulator">
                                        <strong>Itch.io page for the project is now live!</strong>
                                    </Link>
                                    <p></p>
                                    <iframe title="Ice Resurfacing Simulator" frameborder="0" src="https://itch.io/embed/4908508" width="552" height="167"><a href="https://crowback-studios.itch.io/ice-resurfacing-simulator">Ice Resurfacing Simulator by CrowBack Studios</a></iframe>
                                </div>
                            </div>
                        </Col>                            
                    </Row>
                    ...
                    <Row style={{marginTop: '1.5rem'}} className='projects align-items-center justify-content-center mb-4'>
                        <Col xs={10} md={4} lg={4}>
                            <div className='image-card'>
                                ...
                                />
                                <h6 style={{ textAlign: 'center', fontSize: '0.8rem' }}>Changed ice color (early footage)</h6>
                            </div>
                        </Col>
                        <Col xs={12} md={7} lg={6}>
                        ...
                        <Col xs={10} md={4} lg={4}>
                            <div className='image-card'>
                                <AutoPlayVideo 
                                    ...
                                    className="current-project-image" 
                                />
                                <h6 style={{ textAlign: 'center', fontSize: '0.8rem' }}>Example of a coroutine action (early footage)</h6>
                            </div>
                        </Col>
                        <Col xs={12} md={7} lg={6}>
                            <div style={{ padding: '1rem'}}>
