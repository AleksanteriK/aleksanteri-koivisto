                            ...
                            <Col xs={10} md={8} lg={6} className="d-flex flex-column align-items-center">
                                <div>
                                    ...
                                    >
                                        ...
                                        <h4 className='current-project-title' style={{ margin: '10px 0 0 0', fontWeight: 'bold', textAlign: 'center', padding:'1' }}>Ice Resurfacing Simulator</h4>
                                    </Link>
                                </div>
                            </Col>
                        </Row>
                            ...
                            <Col xs={10} md={8} lg={6} className="d-flex flex-column align-items-center">
                                <div style={{ padding: '1rem', backgroundColor: '#1f2127', borderRadius: '10px', marginBottom: '10px' }}>
                                    <div style={{textAlign: 'center' }}>
                                        <small>A solo game project that is currently in development</small>
                                    </div>
                                </div>
                            </Col>                            
                        </Row>
